...
import pages.login.dashboard.customers.contactPerson.ContactPerson_OR;
...
public class CommonFunctions extends BaseComponent {
	...
	public void logOut() {
		...
		if (login.isAlreadyLoggedOut())
			...
			// click(Shared_OR.logOut); ... This code is temprory commented
			// click on profile button
			click(Shared_OR.profileButton);
			pause(SibConstant.LOW);
			click(Shared_OR.LogoutButton);
			// ****** This code is added by sheetal
			// Verification for the login button present after logout

			// Changes by dhruvil on 14th sept 2019
			// wait for login button to be displayed
			pause(SibConstant.MODERATE);
	 ...
	 * 
	 * @param linklocator-
	 *            locator to identify the particular module/submodule link
	 * 
	 * @param backcolorcode-
	 *            HEX code of the background/font color property of the link
	 * 
	 * @param module-
	 *            Module or submodule name for which you want verify whether it
	 *            is already clicked or not
	 * 
	 * @param cssProperty-
	 *            Type of the CSS Property for which you want to verify the
	 *            color attribute
	 */
	...
	/**
	 * @Objective: Method to Convert RGB value to Hex & get the Background color
	 *             of particular element
	 * 
	 * @author vivekp
	 * 
	 * @param locator-
	 *            locator of the WebElement for which backgroup color is
	 *            required
	 * 
	 */
	...
	/**
	 * To check if page is loaded by verifying the header. then returning true
	 * if page is matched else false
	 * 
	 * @author rajatg
	 * 
	 ...
	 * 
	 * @param expectedPageHeader-
	 *            Page Header which need to verified
	 */
	 ...
	 * 
	 * @param patientMenuOption
	 *            - Use PatientMenuOption Interface to select specific Option
	 * 
	 * @param pageHeader
	 *            - Specify Page Header for verification
	 * 
	 ...
	 * 
	 * @param menuOption
	 *            - Specify the Menu Option which need to be open
	 * 
	 * @param pageHeader
	 *            - Expected Page Header After loading a page
	 * 
	...
	private <Type> Type openPatientSpecificOption(String patientMenuOption, String pageHeader) {
		...
		By patListOption = getLocator(Shared_OR.pateientMenuListOpt, ERPBaseSuite.loggedPatientName, patientMenuOption);
	 ...
	 * @author AbhijitG
	 * 
	 * @param i_calendar_index
	 *            = This will pass which calendar user want to click on the page
	 *            (index starts from 0) s_day = To pass the date as a string
	 * 
	 */
	 ...
	 * 
	 * @param noDays
	 *            = Pass the Integer value to set the date range from current
	 *            date
	 */
	...
	/**
	 * @Objective: Method to traverse page by page and store data of each cell
	 *             of a particular column in an Array
	 * 
	 * @author vivekp
	 * 
	 * @param tableXpathLoactor
	 *            - Xpath of Particular table from which you want to get Data
	 * 
	 * @param columnName
	 *            - Column Name visible on front end
	 * 
	 ...
	 *            Locator of drop- down element**
	 * @param optionValue
	 *            Value attribute of option or visible text of option as String
	 * 
	 * @author kandarpp
	 * 
	 */
	 ...
	 * 
	 * @param stringSet
	 *            - Specify the Sting set out of which you want to generate
	 *            random string
	 * 
	 ...
	 * @author vivekp
	 * 
	 * @param actualMsgContent-
	 *            ArrayList of the Front End Message Content
	 * 
	 * @param expectedMsgContent-
	 *            String Array of Back End Message Content
	 */
	 ...
	 * 
	 * @author himanshuk
	 * @return true - If the page is switched. false - If the page is not
	 *         switched.
	 */
	...
	/**
	 * <strong>Objective:</strong> Get all the data from table and return 2D
	 * array.
	 * 
	 * @author himanshuk
	 ...
	 * @param tableLocator
	 * @param element
	 * @return boolean returns true if element is found in table returns false
	 *         if element is not found in table
	 * @author ankitas
	 */
	 ...
	 * 
	 * @param time
	 *            - pass the time in 12 hour format(i.e. 02:00 PM)
	 * 
	 ...
	 * 
	 * @param locator,
	 *            length, and type of random data
	 *
	 */
	 ...
	 * 
	 */
	public boolean verifyNotification(String expectedTitle, String expectedMessage) {
	 ...
	 * 
	 * @param list
	 *            of the column names which need to ignore
	 * 
	 * @param column
	 *            head locator
	 * 
	 ...
	 * 
	 * @param the
	 *            option need to select the from the drop-down
	 * 
	 * @param column
	 *            head locator
	 * 
	 ...
	 *            of option
	 * 
	 * @return true - If the given option is available in the drop-down. false -
	 *         If given option is not available in the drop-down
	 */
	 ...
	 * 
	 * @param value
	 *            value to be entered in the locater
	 * @author rajatg
	 * 
	 */
	@Override
	 ...
	 * 
	 * @param tablelocator,
	 *            the name of the columns which should be ignore and
	 *            columnHeadLocator
	 * 
	 * @return Arraylist
	 */
	...
	/**
	 * This method is used to verify if button is disabled or not using its
	 * locator
	 * 
	 * @author sheetald
	 * 
	 * @param locator
	 *            This is the locator of button of which one wants to find the
	 *            disability.
	 */
	 ...
	 * 
	 * @param locator
	 *            This is the locator of input field
	 */
	 ...
	 * 
	 * @param locator
	 *            This is the locator of element which is not displayed in the
	 *            grid
	 * @param tableLocator
	 *            This is the locator of table grid(enter locator for Table data
	 *            area except Table head area)
	 */
	 ...
	 * 
	 * @param timeOut
	 *            This is the wait for timeout in miliseconds
	 */
	...
	/**
	 * This method is used to apply explicit wait using condition and locator
	 * for particular element
	 * 
	 * @author dhruvilb
	 * 
	 * @param timeOut
	 *            This is the timeout in miliseconds
	 * @param condition
	 *            This is the condition for element
	 * @param locator
	 *            This is the locator of element
	 */
	 ...
	 *            of tagOption
	 * 
	 * @return true - If the given option is available in the tag list. false -
	 *         If given option is not available in the tag list.
	 */
	 ...
	 *            of option
	 * 
	 * @return true - If the drop-down field is enabled. false - If the
	 *         drop-down field is disabled.
	 */
	...
	/*
	 * This method to add tags
	 */

	public void addTag(String tagValue) {
		setValue(Products_OR.tagField, tagValue);
		pressEnterButton(Products_OR.tagField);
